...
with open("tensorflow/lite/micro/examples/mobile_net_v1/input_data.cc", "w") as f:
...
with open("tensorflow/lite/micro/examples/mobile_net_v1/input_data.h", "w") as f:
